...
namespace PrimitiveSetup {
    ...
    void Rectangle::Prepare(Primitive& primitive, const Texture* texture, const math::Vector2D& size) {
    ...
    void Rectangle::Prepare(Primitive& primitive, const Texture* texture) {
