...
class Drawable {
  public:
    ...
    void set_draw_setup_function(const std::function<void (const Drawable*, const Geometry&, const VisualEffect&)> &func) {
  ...
  protected:
    ...
    std::function<void (const Drawable*, const Geometry&, const VisualEffect&)> draw_setup_function_;
};
