...
if (OGRE_INCLUDE_DIR)
  ...
  if (OGRE_CONFIG_HEADER)
    ...
    elseif (OGRE_CONFIG_STATIC OR OGRE_STATIC)
      ...
      pkg_message(OGRE "OGRE_CONFIG_STATIC=${OGRE_CONFIG_STATIC}")
      pkg_message(OGRE "OGRE_STATIC=${OGRE_STATIC}")
...
if (OGRE_STATIC)
  ...
  if (APPLE AND NOT OGRE_BUILD_PLATFORM_APPLE_IOS AND NOT ANDROID)
    set(OGRE_LIBRARIES ${OGRE_LIBRARIES} ${Carbon_LIBRARIES} ${Cocoa_LIBRARIES})
  else()
    message(STATUS "${X11_Xt_FOUND}")
    message(STATUS "${X11_Xt_LIB}")
    set(OGRE_LIBRARIES ${OGRE_LIBRARIES} ${X11_LIBRARIES} ${X11_Xt_LIB} ${XAW_LIBRARY} ${X11_Xrandr_LIB} ${CMAKE_DL_LIBS})
  endif()
  
  if (NOT ZLIB_FOUND OR NOT ZZip_FOUND)
    pkg_message(OGRE "Could not find neither ZLIB nor ZZip.")
    set(OGRE_DEPS_FOUND FALSE)
  endif ()
  if (NOT FreeImage_FOUND AND NOT OGRE_CONFIG_FREEIMAGE)
    pkg_message(OGRE "Could not find FreeImage.")
    set(OGRE_DEPS_FOUND FALSE)
  endif ()
  if (NOT FREETYPE_FOUND)
    pkg_message(OGRE "Could not find FreeType.")
    set(OGRE_DEPS_FOUND FALSE)
  endif ()
  if (UNIX AND NOT APPLE AND NOT ANDROID)
	  if (NOT X11_FOUND)
      pkg_message(OGRE "Could not find X11.")
      set(OGRE_DEPS_FOUND FALSE)
	  endif ()
  endif ()
endif()
...
if (OGRE_CONFIG_THREADS)
  if (OGRE_CONFIG_THREAD_PROVIDER EQUAL 1)
    ...
    if (NOT Boost_THREAD_FOUND)
      pkg_message(OGRE "Could not find Boost thread.")
      set(OGRE_DEPS_FOUND FALSE)
    else ()
