...
find {headers,src}/ugdk-core src/ugdk-script -type f -not -path "*/languages/*" | sort >> src/src_list.cmake
echo ")" >> src/src_list.cmake
echo "Arquivo src/src_list.txt criado com sucesso."

# 2D SOURCE
echo "SET(UGDK_2D_SRC " > src/2d_module_src_list.cmake
find {headers,src}/ugdk-2d -type f | sort >> src/2d_module_src_list.cmake
...
find {headers,src}/ugdk-3d -type f | sort >> src/3d_module_src_list.cmake
...
find headers/ugdk-core/ugdk/script/languages/lua -type f  | sort >> src/lua_src_list.cmake
find src/ugdk-script/languages/lua -type f  | sort >> src/lua_src_list.cmake
...
find headers/ugdk-core/ugdk/script/languages/python -type f  | sort >> src/py_src_list.cmake
find src/ugdk-script/languages/python -type f  | sort >> src/py_src_list.cmake
